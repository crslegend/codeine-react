              ...
              return (
                <Card key={index} className={classes.card}>
                  <CardActionArea
                    ...
                    disabled={
                      course && (!course.is_available || course.is_deleted)
                    }
                    style={{
                      opacity:
                        course &&
                        (!course.is_available || course.is_deleted) &&
                        0.5,
                      height: "90%",
                    }}
                  >
                    ...
                    <div style={{ height: "65%" }}>
                      ...
                      >
                        ...
                        <div style={{ marginBottom: "10px" }}>
                          {(() => {
                            if (course.is_deleted && !course.is_available) {
                              return (
                                <div>
                                  {deletedChip}
                            ...
                            } else if (course.is_deleted) {
                              return deletedChip;
                            } else if (!course.is_available) {
                              return deactivatedChip;
