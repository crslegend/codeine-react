...
const App = () => {
  return (
    <Switch>
      ...
      <MemberAndPublicRoute exact path="/courses/:id" strict sensitive component={ViewCourseDetails} />
      <MemberRoute exact path="/courses/enroll/:id" strict sensitive component={EnrollCourse} />
      <MemberRoute exact path="/courses/enroll/consultation/:id" strict sensitive component={BookConsult} />
      <LandingPageRoute exact path="/member/login" component={MemberLoginPage} user="member" />
      <LandingPageRoute exact path="/member/register" component={MemberRegisterPage} user="member" />
      <PrivateRoute exact path="/member/dashboard" component={MemberDashboardPage} user="member" />
      <PrivateRoute exact path="/member/articles" component={MemberArticlePage} user="member" />
      <PrivateRoute exact path="/partner/articles" component={MemberArticlePage} user="partner" />
      <PrivateRoute exact path="/admin/articles" component={MemberArticlePage} user="admin" />
      <PrivateRoute exact path="/member/courses" component={MemberCoursePage} user="member" />
      <PrivateRoute exact path="/member/consultations" component={MemberConsultationPage} user="member" />
      <PrivateRoute exact path="/member/helpdesk" component={MemberHelpdeskPage} user="member" />
      <PrivateRoute exact path="/member/helpdesk/contact-us" component={CreateNewTicketPage} user="member" />
      <PrivateRoute exact path="/member/helpdesk/tickets" component={ViewSubmittedTicketsPage} user="member" />
      <PrivateRoute strict sensitive path="/member/helpdesk/tickets/:id" component={ViewTicketPage} user="member" />
      <PrivateRoute exact path="/member/membership" component={Membership} user="member" />
      <PrivateRoute exact path="/member/profile" component={MemberProfilePage} user="member" />
      <PrivateRoute exact path="/member/profile/changepassword" component={MemberPasswordPage} user="member" />
      <PrivateRoute exact path="/member/payment" component={MemberPaymentPage} user="member" />
      <PrivateRoute exact path="/article/edit/member/:id" component={EditArticlePage} user="member" />
      <PrivateRoute exact path="/article/edit/partner/:id" component={EditArticlePage} user="partner" />
      <PrivateRoute exact path="/article/edit/admin/:id" component={EditArticlePage} user="admin" />
      <PrivateRoute exact path="/member/notifications" component={AllNotifications} user="member" />
      <PrivateRoute exact path="/partner/notifications" component={AllNotifications} user="partner" />
      <PrivateRoute exact path="/admin/notifications" component={AllNotifications} user="admin" />
      <PrivateRoute exact path="/member/notification/view/:id" component={NotificationDetail} user="member" />
      <PrivateRoute exact path="/partner/notification/view/:id" component={NotificationDetail} user="partner" />
      <PrivateRoute exact path="/admin/notification/view/:id" component={NotificationDetail} user="admin" />
